...
static void usage(void)
{
	...
	printf("example:\n"
	       "  wpa_supplicant -D%s -iwlan0 -c/etc/wpa_supplicant.conf ygg v1\n",
...
int main(int argc, char *argv[])
{
	...
	exitcode = 0;
	wpa_printf(MSG_ERROR, "ygg before wpa_supplicant_init iface_count %d",iface_count);
	printf( "ygg printf  before wpa_supplicant_init iface_count %d \n",iface_count);
